...
<div class="container">
    <div class="header-area">
        <div class="page-info"><h1>Scholarships</h1></div>
        <div class="search-wrapper">
            <input type="text" id="mainSearch" onkeyup="liveSearch()" placeholder="Filter scholarships...">
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <?php if(empty($all_rows)): ?>
                <tr>
                    <td colspan="6" style="text-align:center; padding: 50px; color: var(--text-light);">No scholarships posted yet.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
function liveSearch() {
    ...
    document.querySelectorAll("tbody tr").forEach(row => { 
        if(!row.innerText.includes("No scholarships posted")) {
