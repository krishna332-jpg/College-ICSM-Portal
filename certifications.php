...
<head>
    <meta charset="UTF-8">
    <title>Certification Management | Admin</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        /* Expired Logic */
        .expired { background: #f8fafc; opacity: 0.85; border: 1px solid #e2e8f0; }
...
<div class="container">
    <div class="header-area">
        <div class="page-info"><h1>Certifications</h1></div>
        <div class="search-wrapper">
            <input type="text" id="mainSearch" onkeyup="liveSearch()" placeholder="Filter certifications...">
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <?php if(empty($all_rows)): ?>
                <tr>
                    <td colspan="6" style="text-align:center; padding: 50px; color: var(--text-light);">No certifications posted yet.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
function liveSearch() {
    ...
    document.querySelectorAll("tbody tr").forEach(row => { 
        if(!row.innerText.includes("No certifications posted")) {
